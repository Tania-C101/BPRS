...
<!--Appointment Report Sub Component-->
...
<body class="home">
      ...
      <div class="form-container display-font">
        ...
        <form id="reportForm" action="" method="POST">
          <div class="form-group">
            ...
            <input type="date" id="report1_from_date" name="from-date">
          </div>
          <div class="form-group">
            <label for="to-date">To date</label>
            <input type="date" id="report1_to_date" name="to-date">
          </div>
          <div class="form-group">
            <input type="submit" id="report1_submitButton" value="Submit">
          </div>
        </form>
      </div>
    </div>
  ...
  <script>
    document.getElementById('reportForm').addEventListener('submit', function (event) {
      ...
      var fromDate = document.getElementById('report1_from_date').value;
      var toDate = document.getElementById('report1_to_date').value;
