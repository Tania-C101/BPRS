...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($result->num_rows > 0) {
		...
		echo "<script>alert('No employee found with the provided Employee ID'); window.location.href='be_manager_manage_employee_profile.php';</script>";
	}
	$stmt->close();
} else {
			...
			<ul class="dropdown-menu settings-dropdown-menu">
				...
				<li class="dropdown-tab">
					<a class="dropdown-items dropdown-link settings-dropdown-items"
						href="be_manager_change_password.php" id="change-password-link">Change
						Password</a>
				</li>
			</ul>
		</div>
		...
		<div class="left-Panel">
			<nav class="navbar navbar-light justify-content-start vertical-menu">
				...
				<div class="dropdown">
					...
					<!--Main Component Link-->
					<a class="nav-item nav-link backend-nav btn dropdown-toggle" href="be_manager_inquiry_mgt.php"
				...
				<div class="dropdown">
					...
					<a class="nav-item nav-link backend-nav btn dropdown-toggle active"
						href="be_manager_manage_system_users.php" role="button" id="dropdownMenuLink"
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						...
						<li>
							<a class="dropdown-item active" href="be_manager_manage_employee_profile.php">Manage
								Employee Profile</a>
						</li>
						<li>
							<a class="dropdown-item" href="be_manager_manage_client_profile.php">Manage Client
								Profile</a>
						</li>
					</ul>
				</div>
		...
		<div class="form-container display-font">
			<form method="post" action="">
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="xxxxxxxx" name="employee_id" id="employee_id"
