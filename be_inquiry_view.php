            ...
            <tbody>
              ...
              if ($stmt_inq) {
                while ($row = $stmt_inq->fetch_assoc()) {
                  ...
                  echo "<td class='text-center'><a href='be_inquiry_view_extend.php?viewid=" . htmlspecialchars($row['Inquiry_ID']) . "' style='text-decoration: none; color: #ffffff'><button class='btn btn-primary btn-lg buttonBE'>View</button></a></td>";
                  echo "</tr>";
                }
                ...
                echo "<td class='text-center'><a href='be_inquiry_view_extend.php?viewid=" . htmlspecialchars($userDetails['Inquiry_ID']) . "' style='text-decoration: none; color: #ffffff'><button class='btn btn-primary btn-lg buttonBE'>View</button></a></td>";
                echo "</tr>";
              }
              ?>
            </tbody>
