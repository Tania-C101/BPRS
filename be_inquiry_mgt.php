    ...
    <div class="left-Panel">
      <nav class="navbar navbar-light justify-content-start vertical-menu">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <li>
              <a class="dropdown-item active" href="be_inquiry_mgt.php">Manage Inquiries</a>
            </li>
            <li>
          ...
          <tbody class="borderBE">
            ...
            while ($row = mysqli_fetch_array($retrieve_sql)) {
              ...
              <tr>
                ...
                <!--View button column-->
                <td class="inquiryTableRow">
                  <a id="view_inquiry_Button" href="be_inquiry_reply.php?viewid=<?php echo $row['Inquiry_ID']; ?>"
