...
if (isset($_POST['user_email'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    $query = "UPDATE employees SET Password='$hashedTempPassword' WHERE Email='$email'";
...
<body>
  <center>
    ...
    <br>
    <form id="forgot_password_form" method="post" action="forgot_password_admin.php" style=" width: 50%; padding: 50px 50px 45px 50px; border-radius: 20px;
