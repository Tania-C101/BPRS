  ...
  <div class="main-container">
    <div class="left-Panel">
      <nav class="navbar navbar-light justify-content-start vertical-menu">
        ...
        <div class="dropdown">
          <!--Main Component Link-->
          <a class="nav-item nav-link backend-nav btn dropdown-toggle active" href="be_manage_system_users.php"
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <li>
              <a class="dropdown-item active" href="be_manage_system_users.php">Manage System Users</a>
            </li>
            <li>
    ...
    <div class="right-Panel">
      ...
      <form method="post" class="form-style display-font" id="user-form">
        ...
        <div style="padding-top: 30px">
          ...
          <br />
          <select style="font-size: 14px;" class="form-control" name="employee_category" id="employee_category"
            required>
